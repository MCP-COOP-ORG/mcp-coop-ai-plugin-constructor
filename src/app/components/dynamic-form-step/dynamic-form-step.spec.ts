            ...
            categories: [
                {
                    ...
                    visibility: true,
                    items: [
                        { id: 'item1', label: 'Item 1', visibility: true },
                        { id: 'item2', label: 'Item 2', visibility: true },
                    ],
                },
                {
                    id: 'cat2',
                    ...
                    type: 'radio',
                    visibility: true,
                    items: [{ id: 'opt1', label: 'Opt 1', visibility: true }],
                },
                {
                    id: 'cat3',
                    title: 'Category 3',
                    type: 'textarea',
                    visibility: true,
                    items: [{ id: 'placeholder', label: 'Placeholder', visibility: true }],
                },
                {
                    id: 'cat4',
                    ...
                    visibility: true,
                    items: [
                        { id: 'def1', label: 'Default 1', visibility: true },
                        { id: 'def2', label: 'Default 2', visibility: true },
                    ],
                },
            ],
        };
